                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <ul class="post-tags">
                        ...
                        <?php
                        if ($mb->status == "1") { ?>
                          <a href="<?= base_url('customer/rental/tambah_rental/' . $mb->id_mobil) ?>" class="badge badge-primary m-1"> Rental</a></li>
                        <?php } else { ?>
                          <a href="#" class="badge badge-secondary m-1"> Tidak Tersedia</a></li>
                        <?php } ?>
